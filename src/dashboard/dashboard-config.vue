...
<template>
	<div class="dashboard-page-wrapper">
		<div class="dashboard-page-container shadow-sm rounded">
			<div
				class="d-flex align-items-center justify-content-between mb-2 gap-3"
			>
				<div class="d-flex align-items-center toggle-wrapper">
					<span :class="['toggle-label', !isEnabled ? 'active' : '']"
						>Disabled</span
					>
				...
				<button
					@click="toggleTheme"
					class="btn btn-outline-secondary square-button"
					:title="'Toggle Theme'"
				>
			...
			<div class="custom-message-wrapper mb-4 text-center">
				...
				<form
					@submit.prevent="saveCustomMessage"
				...
				>
					...
					>
						<span v-if="isDirty" class="text-warning small me-auto"
